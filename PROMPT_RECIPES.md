...
|---|---|---|---|---|---|
| **D** | `bronze` | 평범 | 단순 직선 필리그리, 장식 거의 없음 | 10% | 산화된 구리색 `#b8b8c0` |
| **C** | `silver` | 희귀 | 덩굴 패턴 시작, 모서리에 작은 소용돌이 | 30% | 차가운 은색 `#3a7bd5` 틴트 |
| **B** | `gold` | 고귀 | 꽃봉오리·별 패턴, 상하단 장식 크라운 | 55% | 자수정빛 은 `#9b59b6` 틴트 |
| **A** | `legendary` | 전설 | 밀도 높은 스크롤워크, 코너 보석 4개 | 80% | 연마 금 `#f39c12` |
...
| 등급 | 디테일 | 배경 | 포즈 | 라이팅 |
|---|---|---|---|---|
| 평범 | 40% 미니멀, 플랫 채색 | 단색 or 투명 | 정적 스탠딩 | 앰비언트만 |
| 희귀 | 60% 2~3톤 채색 | 포인트 광원 1개 | 정적~살짝 동적 | 포인트 1개 |
| 고귀 | 75% 스타일라이즈드 | 단순화 배경 | 액션 | 2광원 드라마틱 |
| 전설 | 90% 고퀄 일러스트 | 드라마틱 배경 | 다이내믹 액션 | 풀 라이팅 셋업 |
